...
class DeCraftFlagImprovisedBag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ImprovisedBag_FlagBase");//you can insert multiple ingredients this way
		...
		//result2
		AddResult("Flag_");//add results here
	...
	{
		Debug.Log("Decrafted Improvised Flag Bag","Recipes by Pechyvo");
	}
};
