...
class CraftFlagCourierBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Courier Flag Bag";
		...
		//result1
		AddResult("CourierBag_");//add results here
	...
	{
		Debug.Log("Crafted Courier Flag Bag","Recipes by Pechyvo");
	}
};