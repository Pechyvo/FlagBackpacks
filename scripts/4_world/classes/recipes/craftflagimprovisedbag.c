...
class CraftFlagImprovisedBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Improvised Flag Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CourierBag_FlagBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("ImprovisedBag_");//add results here
	...
	{
		Debug.Log("Crafted Improvised Flag Bag","Recipes by Pechyvo");
	}
};